...
\begin{figure}
    \begin{center}
%    \includegraphics[scale=.5]{ContextByDateUnbinnedWithDots2.pdf}
...
\begin{figure}
    \begin{center}
%    \includegraphics[scale=.5]{FormByDateUnbinnedWithDots2.pdf}
    \caption{N =  7946 tokens}
       \label{molten2}
    \end{center}
\end{figure}
...
\begin{figure}
    \begin{center}
%    \includegraphics[scale=.5]{ContextByDateAuthor.pdf}
...
\begin{figure}
    \begin{center}
%    \includegraphics[scale=.5]{ContextByDateAuthor1570.pdf}
    \caption{stuff}
       \label{molten4}
    \end{center}
\end{figure}
